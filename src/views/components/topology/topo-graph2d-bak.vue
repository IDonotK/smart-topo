<template>
  <div id="network" class="topo-graph2d">
...
<script>
  ...
  export default {
    ...
    methods: {
      initData() {
        const svgWidth = this.$refs.tg2dSvg.clientWidth;
        const svgHeight = this.$refs.tg2dSvg.clientHeight;
        ...
        this.force = d3
          ...
          .force('charge', d3.forceManyBody().strength(this.bodyStrength))
      ...
      svgMouseover(e) {
        if (e.target.nodeName === 'circle') {
          ...
          this.linkTextPosition = {
            left: e.clientX - 220 + 'px', // 220需要动态计算
            top: e.clientY - 50 + 'px',
          };
