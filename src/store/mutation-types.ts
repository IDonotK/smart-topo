...
export const SET_SHOW_NODE_TYPE_FILTER = 'SET_SHOW_NODE_TYPE_FILTER';
export const SET_HIDE_NODE_TYPE_FILTER = 'SET_HIDE_NODE_TYPE_FILTER';
export const SET_NODE_STATE_TYPE_FILTER = 'SET_NODE_STATE_TYPE_FILTER';
export const SET_SHOW_EDGE_TYPE_FILTER = 'SET_SHOW_EDGE_TYPE_FILTER';
export const SET_ZOOM_CONTROLLER = 'SET_ZOOM_CONTROLLER';
export const SET_RELATIVE_NODE_TYPE = 'SET_RELATIVE_NODE_TYPE';
export const SET_TOPO_BASIC_DATA = 'SET_TOPO_BASIC_DATA';
export const SET_TOPO_SCALE_FIX = 'SET_TOPO_SCALE_FIX';
export const SET_IS_GLOBAL_MODE = 'SET_IS_GLOBAL_MODE';
export const SET_HAS_SEARCHED_GLOBALLY = 'SET_HAS_SEARCHED_GLOBALLY';
export const SET_IS_FROM_GLOBAL_TO_NORMAL = 'SET_IS_FROM_GLOBAL_TO_NORMAL';
